...
def test_find_actions_staeckel():
    ...
    inputs = [
        (w0_one, (1, 3)),
        (w0_many, (xyz.shape[1], 3)),
        (orbit_one, (1, 3)),
        (orbit_many, (xyz.shape[1], 3)),
    ]
    for w, colshape in inputs:
...
def test_compare_staeckel_o2gf():
    """
    This test function performs some comparisons between actions, angles, and
    frequencies solved from the staeckel fudge and O2GF.
    """
    pass