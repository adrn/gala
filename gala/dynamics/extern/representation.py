"""
NOTE: This file is ripped out of @mhvk's PR on astropy/astropy
    https://github.com/astropy/astropy/pull/5871
Once that or something like it is merged into astropy master, switch to using
that instead.
...
from astropy.utils.compat.numpy import broadcast_arrays, broadcast_to
