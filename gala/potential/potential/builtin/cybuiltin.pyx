...
__all__ = ['NullPotential', 'HenonHeilesPotential', # Misc. potentials
           ...
           'SatohPotential', 'KuzminPotential', 'MiyamotoNagaiPotential',
...
class MN3ExponentialDiskPotential(CPotentialBase):
    """
    MN3ExponentialDiskPotential(m, h_R, b, positive_density=True, units=None, origin=None, R=None)
    ...
    def __init__(self, *args, units=None, origin=None, R=None,
        ...
        x = (self.parameters['b'] / self.parameters['h_R']).decompose().value
        x = np.vander([x], N=5)[0]
        ...
        for i in range(3):
            ...
            c_only[f'b{i+1}'] = self.parameters['b'].value
