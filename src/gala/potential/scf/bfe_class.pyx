...
class SCFPotential(CPotentialBase, GSL_only=True):
    ...
    Snlm = PotentialParameter('Snlm', physical_type='dimensionless', ndim=3)
    Tnlm = PotentialParameter('Tnlm', physical_type='dimensionless', ndim=3)
...
class SCFInterpolatedPotential(CPotentialBase, GSL_only=True):
    ...
    m = PotentialParameter('m', physical_type='mass')
    r_s = PotentialParameter('r_s', physical_type='length')
    Sjnlm = PotentialParameter('Sjnlm', physical_type='dimensionless', ndim=4)
    Tjnlm = PotentialParameter('Tjnlm', physical_type='dimensionless', ndim=4)
