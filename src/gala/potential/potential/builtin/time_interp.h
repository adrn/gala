...
static inline int time_interp_init_constant_param(TimeInterpParam *param, double constant_value) { return -1; }
...
static inline double time_interp_eval_param(const TimeInterpParam *param, double t) { return 0.0; }
